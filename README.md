The program is to train a simple unconditional DDPM. I started train the model as I was just curious, why diffusion model works well and how does the loss curve looks like.
